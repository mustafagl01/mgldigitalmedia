  ...
  automation: {
    ...
    included: {
      tr: [
        ...
        'CRM kurulumu ve müşteri adayı takibi',
        'Otomatik hatırlatma ve takip mesajları',
        'Sadakat ve tekrar müşteri akışları',
      ...
      en: [
        ...
        'Automatic reminders and follow-up messages',
        'Loyalty and repeat-customer flows',
  ...
  'web-landing': {
    ...
    included: {
      tr: [
        ...
        'Google İşletme Profili ve Maps kurulumu',
  ...
  'web-site': {
    ...
    included: {
      tr: [
        ...
        'Google İşletme Profili ve Maps kurulumu, yerel SEO',
        'Teknik SEO ve içerik optimizasyonu',
        'Kurumsal e-posta kurulumu',
      ...
      en: [
        ...
        'Google Business Profile and Maps setup, local SEO',
  ...
  'web-integrated': {
    ...
    included: {
      tr: [
        ...
        'Online sipariş, rezervasyon ve randevu altyapısı',
        'QR menü',
      ...
      en: [
        ...
        'Online ordering, reservations and appointment booking',
        'QR menu',
  ...
  'ads-meta': {
    ...
    included: {
      tr: [
        ...
        'Arama ve yapay zekâ aramalarında görünürlük takibi (SEO / GEO)',
        'Aylık rapor',
      ],
      en: [
        ...
        'Search and AI-search visibility tracking (SEO / GEO)',
        'Monthly report',
      ],
    },
    excluded: {
