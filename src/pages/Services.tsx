...
const services: Service[] = [
  ...
  },
  {
    ...
    featuresTR: ['Kapsam teklifte yazılı belirlenir', 'CRM kurulumu, müşteri adayı takibi ve hatırlatmalar', 'Mevcut araçlarla entegrasyon', 'Hata uyarıları ve izleme', 'Aylık bakım dahil'],
    featuresEN: ['Scope defined in writing', 'CRM setup, lead tracking and reminders', 'Integration with existing tools', 'Failure alerts and monitoring', 'Monthly maintenance included'],
  },
  {
  ...
  },
  {
    ...
    featuresTR: ['Metin ve görsel yerleşimi', 'Google İşletme Profili ve Maps kurulumu', 'Form ve ölçüm kurulumu', 'Sitemap ve temel şema', 'İki revizyon turu'],
    featuresEN: ['Copy and visual layout', 'Google Business Profile and Maps setup', 'Form and measurement setup', 'Sitemap and essential schema', 'Two revision rounds'],
  },
  {
    ...
    featuresTR: ['5–7 temel sayfa', 'Mobil ve erişilebilir tasarım', 'Google İşletme Profili, Maps ve kurumsal e-posta', 'GA4 ve Search Console hazırlığı', 'Teknik ve yerel SEO temeli'],
    featuresEN: ['5–7 core pages', 'Mobile and accessible design', 'Google Business Profile, Maps and business email', 'GA4 and Search Console readiness', 'Technical and local SEO foundations'],
  },
  {
  ...
  },
  {
    ...
    featuresTR: ['Reklam bütçesinden pay yok', 'Pixel/CAPI kurulumu', 'Kreatif test planı', 'Arama ve AI görünürlük takibi (SEO / GEO)', 'Düzenli performans raporu'],
    featuresEN: ['No share of ad spend', 'Pixel/CAPI setup', 'Creative testing plan', 'Search and AI-visibility tracking (SEO / GEO)', 'Regular performance reporting'],
  },
  {
