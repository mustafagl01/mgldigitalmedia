...
const SERVICES: ServiceSku[] = [
  ...
  },
  {
    ...
    features: {
      ...
      en: [
        ...
        'Connected calls £0.15/min; voice, telephony and AI included',
  ...
  },
  {
    ...
    features: {
      tr: [
        'En fazla 3 üretim workflow\'u ve 2 entegrasyon',
        'Self-hosted veya n8n Cloud',
        'Hata bildirimi Telegram / email',
        'İzleme, hata uyarısı ve aylık bakım dahil',
      ],
      en: [
        'Up to 3 production workflows and 2 integrations',
        'Self-hosted or n8n Cloud',
        'Error alerts to Telegram / email',
        'Monitoring, failure alerts and monthly maintenance included',
      ],
    },
  },
  {
