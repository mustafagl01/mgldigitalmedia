  ...
  return (
    <section id="services" className="py-20">
      <div className="container mx-auto px-4">
        ...
        >
          <h2 className="text-4xl md:text-5xl font-bold mb-6 text-slate-900">{t('services.title')}</h2>
          <p className="text-xl text-slate-700 max-w-3xl mx-auto">{t('services.subtitle')}</p>
        </motion.div>
