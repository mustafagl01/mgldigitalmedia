...
export const SignupPage: React.FC<SignupPageProps> = ({ onSwitchToLogin, onBack }) => {
  ...
  const handleGoogleSignIn = async () => {
    console.log('Google kayıt butonu tıklandı');
    setIsLoading(true);
    ...
    try {
      ...
      toast({
        title: "Hata",
        description: "Google kayıt işleminde beklenmeyen bir hata oluştu.",
        variant: "destructive"
      });
      console.error('Google signUp critical error:', error);
    }
